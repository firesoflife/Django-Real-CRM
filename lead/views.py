...
def leads_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Changes to the lead have been saved')
...
def add_lead(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'A new lead was added.')
...
def convert_to_client(request, pk):
    ...
    messages.success(
        request, "The lead was successfully converted to a client.")
